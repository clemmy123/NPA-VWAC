...
<div class="page-header">
    <div>
        <h4 class="page-title">Edit Dimension</h4>
...
<div class="chart-card">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('dimensions.options.create', $dimension) }}" class="btn btn-outline-secondary btn-sm"><i class="mdi mdi-plus"></i> Add Option</a>
    </div>

    <table class="table table-sm mb-0">
        <thead>
            <tr><th>Code</th><th>Name</th><th>Sort</th><th>Status</th><th class="text-end">Actions</th></tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td><span class="s-badge {{ $option->is_active ? 's-active' : 's-inactive' }}">{{ $option->is_active ? 'Active' : 'Inactive' }}</span></td>
                <td class="text-end">
                    <a href="{{ route('dimensions.options.edit', [$dimension, $option]) }}" class="btn-icon" title="Edit"><i class="mdi mdi-pencil-outline"></i></a>
            ...
            <tr>
                <td colspan="5">
                    <div class="tbl-empty">
                        ...
                        <p>No options yet for this dimension.</p>
                    </div>
                </td>
            </tr>
            @endforelse
