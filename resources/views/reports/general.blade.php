...
<div class="chart-card">
    <p class="mb-0 text-muted">Select a period, plan, and thematic area, then click Filter to see monitoring and evaluation analysis.</p>
</div>
...
(function () {
    ...
    projectSelect.addEventListener('change', filterAreas);
    filterAreas();
})();
</script>
