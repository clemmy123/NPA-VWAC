...
<form method="GET" action="{{ route('reports.workstation') }}" class="filter-card report-filters" id="workstation-report-filters">
    ...
    <div class="rf-field">
        <label for="organization_type_id">Workstation Type</label>
    ...
    <div class="rf-field">
        <label for="workstation-search">Search</label>
    ...
    <div class="rf-actions">
        ...
        <a href="{{ route('reports.workstation', ['frequency' => $frequency]) }}" class="btn btn-outline-secondary">Reset</a>
    </div>
</form>
