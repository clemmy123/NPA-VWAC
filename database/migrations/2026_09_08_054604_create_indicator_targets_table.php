...
return new class extends Migration
{
    ...
    {
        Schema::create('indicator_targets', function (Blueprint $table) { $table->id();
        ...
        $table->timestamps();
        $table->unique(['indicator_id', 'financial_year_id', 'reporting_period_id'], 'indicator_target_period_unique');
        });
    }
